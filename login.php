            ...
            <div class="container" style="margin-top: -150px;">
               <div class="row">
                ...
                <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>">
                        ...
                        <div class="password"> <input id="password-field" type="password" name="password" placeholder="كلمة المرور"></div>
                      <p style="color: red;"><?php if(!empty($error)){echo $error.'<br><br>';}?></p>
